    ...
    return (
        <section className="bg-gradient-to-r from-primary-300 via-accent-300 to-primary-300 py-28 px-8 md:px-16">
            <div className="container mx-auto text-center">
                {/* Title */}
                <h2 className="text-3xl sm:text-4xl font-bold text-primary-900 mb-12 leading-snug tracking-tight">
                    Your Generosity, Their Hope: How Your Donations Change Lives
                </h2>

                {/* Content Wrapper */}
                <div className="bg-white p-6 sm:p-10 rounded-xl shadow-2xl mx-auto max-w-4xl space-y-8">
                    {/* Introduction Paragraph */}
                    <p className="text-lg sm:text-xl text-secondary-800 leading-relaxed">
                    ...
                    <div className="text-left space-y-6">
                        <p className="text-secondary-900 font-semibold text-xl sm:text-2xl">
                            Here’s how your support truly makes a difference:
                        </p>
                        <ul className="list-disc pl-6 text-secondary-800 space-y-3 text-lg sm:text-xl">
                            <li>
                    ...
                    <div className="bg-primary-50 p-6 sm:p-8 rounded-lg shadow-inner italic text-secondary-700">
                        ...
                        <p className="mt-4 text-sm sm:text-base text-right font-semibold">
                    ...
                    <div className="mt-12">
                        <button className="bg-gradient-to-r from-accent-500 via-primary-700 to-accent-500 text-white px-4 sm:px-6 py-2 sm:py-3 text-lg sm:text-xl rounded-full shadow-2xl transform hover:scale-110 transition-all duration-300">
