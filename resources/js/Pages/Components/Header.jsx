...
const Header = () => {
    return (
        <header className="sticky top-0 z-50 w-full border-b border-secondary-200">
            <div className="container flex py-5 items-center mx-auto">
                ...
                <nav className="flex flex-1 items-center justify-center gap-10 text-lg font-medium">
                    <Link
                        href="/"
                        className=" relative inline-block active:scale-95 before:absolute before:left-0 before:bottom-0 before:h-[2px] before:w-0 before:bg-secondary-400 before:transition-all before:duration-500 hover:before:w-full hover:text-secondary-400 text-secondary-400"
                    >
                        Home
                    </Link>
                    <Link
