            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="p-4 flex-1 bg-stone-100 rounded-e flex flex-col font-noto">
                    ...
                    <div className="space-y-2 mb-3">
                        ...
                        <p
                            className={`text-xs text-gray-600 ${glutenFree ? "" : "text-red-500"
                                }`}
                        >
                        ...
                        <p
                            className={`text-xs text-gray-600 ${dairyFree ? "" : "text-red-500"
                                }`}
                        >
                        ...
                        <p
                            className={`text-xs text-gray-600 ${nutsFree ? "" : "text-red-500"
                                }`}
                        >
