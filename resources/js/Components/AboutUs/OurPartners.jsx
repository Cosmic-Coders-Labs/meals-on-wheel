    ...
    return (
        <section className="bg-white py-20 px-8">
            <div className="container mx-auto text-center">
                ...
                {/* Button Section */}
                <div className="mt-12">
                    <button className="px-6 py-3 text-lg font-semibold text-white bg-gradient-to-r from-accent-400 via-primary-800 to-accent-700 rounded-full shadow-lg transform transition-all duration-300 hover:scale-105 hover:rotate-3 hover:shadow-2xl" onClick={() => router.visit(route('register'))}>
